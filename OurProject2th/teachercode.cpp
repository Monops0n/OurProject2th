...
{
    ofstream file("C:/Users/Руслан/source/repos/OurProject2th/OurProject2th/data.txt");
...
{
    int count = 0;
    ifstream file("C:/Users/Руслан/source/repos/OurProject2th/OurProject2th/Tests.txt");
    if (file.is_open())
    {
        string line;
...
void deleteQuestion(Title* titles, int numTitle, int countTitles)
{
    ...
    clearFile("C:/Users/Руслан/source/repos/OurProject2th/OurProject2th/Tests.txt");
...
{
    int num = 0;
    ifstream file("C:/Users/Руслан/source/repos/OurProject2th/OurProject2th/data.txt");
    if (file.is_open()) {
        string line;
        while (getline(file, line)) {
...
void addStudent(Student* students, int& count)
{
    ...
    students[count].average = "average: 0.00";
    count++;
}
...
void Menu_Students(vector<Student_1> Students)
{
    ...
    do
    {
        ...
        case 3:
            ...
            if (task == 1)
            {
                Output_All_Topics(Students);
                break;
            }
            else if (task == 2)
            {
                Output_Specific_Topic(Students);
                break;
            }
            break;
        case 4:
